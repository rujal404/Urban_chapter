...
<head>
    ...
    <link rel="stylesheet icon" href="./image/favicon.ico" type="image/x-icon">
...
<body>
    ...
    <nav class="navbar">
        <ul class="nav_links">
            ...
            <li><a class="#featured" href="#">Featured</li>
            <li><a class="#arrival" href="#">Arrival</li>
            <li><a href="./html/reviewPage.html" target="_blank">About Us</li>
            <li><a href="./php/reviewPage.php" target="_blank">Review</li>
        </ul>
        <?php
        if(isset($_SESSION["logged"])) {
            ?>
            <div class="dropdown">
                <!-- <button class="dropbtn"><i class="fas fa-chevron-circle-down"></li></button> -->
                <button class="dropbtn"><i class="fas" fa-user-circle-down"></i></button>
    ...
    <section id="featured">
        ...
        <div class="cards">
            ...
            while ($row = $res->fetch_assoc()) {
                ?>
                <div class="card">
                    <img src="./uploads/thumbnails/<?php echo $row["thumbnail"]; ?>" alt="bool 1">
